...
Components](01_03-platform_architecture.qmd#1-system-components--roles)
2. [Platform Overview — Deployment &
Infrastructure](01_03-platform_architecture.qmd#3-deployment--infrastructure)
