...
This is a test page to verify the Quarto configuration is working
correctly.

- ✅ Quarto configuration should work
- ✅ New directory structure should be recognized
- ✅ CSS styling should apply
