...
| Promotion gates | Model artifacts + MLOps definitions | DEV→UAT→REGRESSION→PROD approval and validation for both product and platform changes |
...
| Package/module workflow | nbdev + Quarto `.qmd` | Canonical ML-researcher workflow and architecture authoring surface |
| Python environment | uv2nix + uv + `.venv` | Nix-controlled dependency sync and reproducible local environment |
