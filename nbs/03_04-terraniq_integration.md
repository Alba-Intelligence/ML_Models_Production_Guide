...
This page mirrors the Nix/Terranix source that generates the OpenTofu
inputs. It exists so the infra story is readable from the website
without browsing the source tree.
...
<img
src="03_04-terraniq_integration_files/figure-commonmark/mermaid-figure-1.png"
style="width:7.74in;height:3.98in" />
...
Generate JSON from the profile you want, write it to
`infra/<profile>/main.tf.json`, then run OpenTofu from that directory.
