...
# %% ../nbs/08_execution_backends.ipynb #d8393d08
...
# %% auto #0
__all__ = ['LocalExecutionResult', 'LocalExecutionAdapter', 'BackendSubmission', 'ExecutionOrchestrator', 'map_to_slurm_job_spec',
