...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_webui_contracts.ipynb.

# %% ../nbs/05_webui_contracts.ipynb #8334f675
...
# %% auto #0
__all__ = ['ExecutionTarget', 'RevisionKind', 'RunStatus', 'build_mlflow_run_url', 'NotebookRevision', 'NotebookExecutionRequest',
           'RunVisibility', 'summarize_run_for_webui']
