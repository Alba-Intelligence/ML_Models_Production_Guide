...
# %% ../nbs/06_vertical_slice.ipynb #f2fdb0df
...
# %% auto #0
__all__ = ['DEFAULT_FEATURES', 'DEFAULT_TARGET', 'PromotionStage', 'TrainingOutcome', 'generate_synthetic_dataset',
           'prepare_training_data', 'train_with_traceability', 'package_and_register_model', 'promote_model_artifact',
           'create_local_deployment_record', 'predict_and_log', 'execute_first_vertical_slice']
