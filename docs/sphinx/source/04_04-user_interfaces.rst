...
This page describes the design for a centralized notebook repository web UI that enables users across all roles to browse, select, and trigger notebook executions across environments while keeping notebooks as the immutable source of truth.
