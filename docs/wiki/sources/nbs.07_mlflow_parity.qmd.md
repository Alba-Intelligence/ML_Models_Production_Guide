---
updated: 2026-05-13
summary: Synthesized summary of Quarto nbdev source-of-truth for MLflow parity and full local-emulation compose helpers.
read_when:
...
Quarto-first source for local MLflow parity helpers:
  ...
  - merged full local-emulation compose generation (data plane + compute plane + AWS emulator)
