---
updated: 2026-05-11
summary: Synthesized summary of docs freshness tests that ensure rendered HTML is not stale versus Quarto sources.
read_when:
...
- Maps each `nbs/*.qmd` source to expected `_docs/nbs/*.html` output.
