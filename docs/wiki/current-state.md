...
- One open question formally recorded in the spec: CI/CD tooling, promotion gate criteria, and PyTorch inference optimisation steps. (Lambda.ai scheduling preference, MLflow PostgreSQL+S3 contract, AWS Kubernetes, and Nix/Terranix boundary decisions resolved)
