...
- [gaps/index.md](gaps/index.md) — structural gaps and tracking.
...
- [sources/nbs.reference.03_Security_Authorization_and_Policy.qmd.md](sources/nbs.reference.03_Security_Authorization_and_Policy.qmd.md) — synthesized summary of the traditional auth, roles, capability, and policy posture for the stack.
